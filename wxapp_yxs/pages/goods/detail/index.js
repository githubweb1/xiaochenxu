...
Page({
  ...
  timeupdata(e){
    ...
    var currentTime = Math.floor(e.detail.currentTime);
     _this.data.videoCtx = wx.createVideoContext(id);    //获取点击的视频
    if (currentTime == _this.data.goods.video_m){
      _this.data.videoCtx.pause()  
        _this.setData({
          isplay:true,
        })
    }
      ...
      wx.login({
        success: function (o) {
          ...
          e.post("wxapp/login", {
            ...
            return o.error ? void e.alert("获取用户登录态失败:" + o.message) : o.isclose && i && "function" == typeof i ? void i(o.closetext, !0) : void e.get("wxapp/auth", {
