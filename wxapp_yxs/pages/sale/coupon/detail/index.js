...
Page({
  ...
  receive: function(e) {
    ...
    var r = "确认使用";
    i.money > 0 && (r += i.money + "元", i.credit > 0 && (r += "+")), i.credit > 0 && (r += i.credit + "积分"), r += i.gettypestr + "吗？", t.confirm(r, function() {
      o.setData({
        buying: !0
      }), t.post("sale/coupon/pay", {
        id: o.data.id
      }, function(e) {
        if (e.error > 0) return a.toast(o, e.message), void o.setData({
          buying: !1
        });
        o.setData({
          logid: e.logid
  ...
  payResult: function() {
    ...
    t.get("sale/coupon/payresult", {
      ...
      1 == i.coupontype && (o = "/pages/member/recharge/index"), t.confirm(i.confirm_text, function() {
        wx.redirectTo({
          url: o
        })
      }, function() {
